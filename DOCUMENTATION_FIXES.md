...
Согласно заданию, была проведена полная проверка и исправление документации библиотеки AsyncMaxBot SDK версии 1.4.0. Работа выполнялась в соответствии с принципом "Проверяй, а не доверяй" из AI_GUIDE.md.
...
- ✅ Какие возможности доступны в версии 1.4.0
...
Все примеры готовы к использованию и демонстрируют реальные возможности библиотеки версии 1.4.0.

---

**Дата завершения:** Текущая дата  
**Версия библиотеки:** 1.4.0  
**Статус:** ✅ Завершено 